...
const DEFAULT_PROMPT_TEMPLATE = [
  ...
  "* Пиши естественно, кратко и понятно, как обычное сообщение Git-коммита.",
  "* Формулируй сообщение от имени автора изменения в прошедшем времени:",
  " «Добавил», «Исправил», «Удалил», «Обновил», «Перенёс», «Упростил» и т.д.",
  "* Первая строка должна кратко описывать основное изменение и быть не длиннее 72 символов.",
  "* Используй повелительный стиль Git на английском не нужно; сообщение должно звучать естественно по-русски.",
  "* Добавляй короткое тело только если без него изменение непонятно.",
  "* Не добавляй деталей, которых нет в diff.",
  "* Основывайся только на предоставленном diff.",
  "* Не добавляй списки, пояснения, кавычки или Markdown вне сообщения коммита.",
  "",
  "Diff mode: {diffMode}",
  "",
  "```diff",
